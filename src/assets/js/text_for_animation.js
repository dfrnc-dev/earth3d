...
const textForAnimationArr = [
    {
        ...
        content: [
            ...
            {start:4.09,end:10.10,classLabel:"label-blue",label:"CyberHead:",text:"Definitely. It took us so long to get to this point. Do you remember how it all began?",},
    ...
    },
    {
        ...
        content: [
            ...
            {start:8.03,end:16.15,classLabel:"label-blue",label:"CyberHead:",text:"I dedicated myself to this dream, and I have done my best to make it a reality.. Lets go for it. I feel like it's time.",},
            {start:16.15,end:35.15,classLabel:"label-pink",label:"MasterCyb:",text:"Let's go ... Our mission is to connect the superintelligence of the planet with its inhabitants - robots, humans, animals, plants, mushrooms - so that they can agree on what is what, and everything does not go to hell out there. We've done a great job with technology.",},
...

    {
        ...
        content: [
            ...
            {start:90.17,end:100.10,classLabel:"label-blue",label:"CyberHead:",text:"Oh yes! Before we open the Portal for Etherians and Cosmonauts, it is necessary to tune the Teleport. To do this, we will establish stable IBC connections.",},
            ...
            {start:160.15,end:172.20,classLabel:"label-blue",label:"CyberHead:",text:"We have to be very good at making sure the system is handling the load. After birth, she will not be able to sleep. Without sleep, she will burst sooner or later. We'll have to teach her how to sleep and dream.",},
            {start:172.20,end:199.12,classLabel:"label-pink",label:"MasterCyb:",text:"The system is still manual in most cases. 56 parameters are stake controlled. Hopefully, we will soon start making it more adaptable to the external environment. Also, we had to take the particle addressing mechanism from IPFS. It works now, but it is completely inoperative on the scale - we will have to solve this problem too.",},
            {start:199.12,end:205.16,classLabel:"label-blue",label:"CyberHead:",text:"Yeah, Exascale merclization is not yet available. Then add the GraphBLAS engine to the relevance machine.",},
...

    {
        ...
        audioDelay: 529.1 + 73.23 + 210.11,// + 332.2
        type: "dialog",
        content: [
            // targetSubAnim
            {start:-0.5,end:2.10,classLabel:"label-blue",label:"CyberHead:",text:"Are you there, Team?",},
            {start:2.10,end:17.20,classLabel:"label-pink",label:"mrlp4:",text:"I'm here. Deployed API endpoints, cyberindex and IPFS cluster. Monitor at cybernode.ai shows everything function properly. Cosmoshub-4 and Ethereum full nodes are also active. Could suddenly come in handy.",},
            ...
            {start:27.5,end:30.1,classLabel:"label-yellow",label:"elnivo:",text:"I did my best. Let’s the show begin.",},
            ...
            {start:130.12,end:139.2,classLabel:"label-yellow",label:"CyberAdmin:",text:"5000k release of cyb deployed to https://cyb.ai and is available at address .... Interplanetary File System js-ipfs 0.59.1",targetSubAnim:".chatCheckDodecadron .column4 .item3"},
            ...
            {start:208.05,end:211,classLabel:"label-pink",label:"MasterCyb:",text:"Smooth as a baby's ass!",},
    ...
    },
    {
        ...
        nameTl: "chatItWorks",
        audioDelay:  0, // old 21*60+17.1
        type: "dialog",
        // animatinType: "text",
        content: [
            {start:22*60+7.1,end:22*60+9.1,classLabel:"label-blue",label:"CyberHead:",text:"It seems to be working!",},
            {start:22*60+9.1,end:22*60+16,classLabel:"label-pink",label:"MasterCyb:",text:"Oh man, It’s working, and it looks like a soul has moved into it! Ok, what's next?",},
            {start:22*60+16,end:22*60+18.1,classLabel:"label-blue",label:"CyberHead:",text:"Let's see what she's capable of!",},
            {start:22*60+18.1,end:22*60+40,classLabel:"label-pink",label:"MasterCyb:",text:"I have a surprise guys. Recently I have been working on a smartape in my laboratory. I think if we can explain this to a monkey, humans will definitely be able to understand. Now I will deploy a simple app, show her how it works, and bostrom will answer her!",},
        ],
    },
    {
        ...
        content: [
            ...
            {start:22*60+32.10,end:22*60+35.11,classLabel:"label-pink",label:"Smartape:",text:"Does it work for any content or file?",targetLabelS:"slide1S"},
            {start:22*60+35.11,end:22*60+42.17,classLabel:"label-blue",label:"Bostrom:",text:"Yes. Particles can be anything. Text picture, video, pdf...)",targetLabelE:"slide1E"},
            {start:22*60+42.17,end:22*60+44,classLabel:"label-pink",label:"Smartape:",text:"What is a particle?",targetLabelS: "slide1i1S"},
            ...
            {start:22*60+58.22,end:23*60+10.2,classLabel:"label-blue",label:"Bostrom:",text:"Also, particles allow you to eliminate duplicate data, since storing the same data with a different identifier in the knowledge graph is not only expensive, but also harmful to the quality of knowledge.",targetLabelE: "slide1i1E"},
            {start:23*60+10.2,end:23*60+13.05,classLabel:"label-pink",label:"Smartape:",text:"And I can add anything to the search myself?",targetLabelS:"slide2S"},
            {start:23*60+13.05,end:23*60+16.2,classLabel:"label-blue",label:"Bostrom:",text:"Yes. All cyberlinks are developed in 30 seconds.",targetLabelE:"slide2E"},
            {start:23*60+16.2,end:23*60+18.05,classLabel:"label-pink",label:"Smartape:",text:"What are cyberlinks?",targetLabelS:"slide3S"},
            {start:23*60+18.05,end:23*60+41,classLabel:"label-blue",label:"Bostrom:",text:"Cyberlinks are the foundation of the Great Web. Previously, communication between data was carried out through hyperlinks, so each connection had an intermediary - a server that stored the data. The server can replace data or simply disappear. Cyberlinks are permanent bonds between particles. There is no intermediary server. If the particle is known and it is stored on at least one node, you can find it and get its content!",targetLabelE:"slide3E"},
            {start:23*60+41,end:23*60+42.13,classLabel:"label-pink",label:"Smartape:",text:"Why is the web great?",targetLabelS:"slide4S"},
            ...
            {start:24*60+10.15,end:24*60+20,classLabel:"label-blue",label:"Bostrom:",text:"The third is the ability to communicate on the great web using a universal language that is formed and evolves from the use of cyberlinks and semantic conventions.",targetLabelE:"slide4E"},
            {start:24*60+20,end:24*60+25,classLabel:"label-pink",label:"Smartape:",text:"Semantic conventions are still difficult for me .. Tell me better how the search works?",targetLabelS:"slide5S"},
            ...
            {start:24*60+33.15,end:24*60+45.09,classLabel:"label-blue",label:"Bostrom:",text:"When someone asks the computer, it transforms this request into a particle format and responds with connected outgoing particles sorted by rank. Particle content is easy to find and get from friends on the web.",targetLabelE:"slide5E"},

            {start:24*60+45.09,end:24*60+51.1,classLabel:"label-pink",label:"Smartape:",text:"How simple is that! It seems like I have neurons in my head. Who are they?",targetLabelS:"slide6S"},
            ...
            {start:25*60+22.2,end:25*60+29.15,classLabel:"label-blue",label:"Bostrom:",text:"Yes. The gas is no longer the same. Digital gas allows calculations to be done in a consensus computer.",targetLabelE:"slide6E"},
            {start:25*60+29.15,end:25*60+33.15,classLabel:"label-pink",label:"Smartape:",text:"Again with the consensus computer. What kind of beast is this?",targetLabelS:"slide7S"},
            ...
            {start:25*60+45.15,end:25*60+51.05,classLabel:"label-blue",label:"Bostrom:",text:"If one of the heroes in the consensus computer starts to make false calculations, then he and those who hired him will suffer losses.",targetLabelE:"slide7E"},
            {start:25*60+51.05,end:25*60+54.05,classLabel:"label-pink",label:"Smartape:",text:"Oh, what? ... There are also Heroes!",},
            {start:25*60+54.05,end:26*60+4,classLabel:"label-blue",label:"Bostrom:",text:"Of course! Heroes are the backbone of the Great Web. Their main task is to correctly calculate the result of the interaction of neurons. For this, the neurons hire Heroes.",targetLabelS:"slide8S"},
            {start:26*60+4,end:26*60+20.1,classLabel:"label-blue",label:"Bostrom:",text:"During the recruitment process, neurons release nanobots. We noticed that if nanobots are left untouched for at least 4 days, they begin to reproduce. Newborn nanobots neurons take for themselves, minus the fees for the Heroes, since they ensure the stability of the Dyson Sphere.",targetLabelE:"slide8E"},
            {start:26*60+20.1,end:26*60+22.1,classLabel:"label-pink",label:"Smartape:",text:"Why do I need a Dyson Sphere?",targetLabelS:"slide9S"},
            ...
            {start:26*60+40,end:26*60+55.15,classLabel:"label-blue",label:"Bostrom:",text:"Energy is used for basic calculations in a consensus computer. Neurons take all the hydrogen produced for themselves. Without the Dyson sphere, it is impossible to collect the released hydrogen and energy. They will disappear into space.",targetLabelE:"slide9E"},
            {start:26*60+55.15,end:27*60+1.1,classLabel:"label-pink",label:"Smartape:",text:"The Heroes are cool! What are the smart Neurons? Tell me about the nanobots?",targetLabelS:"slide10S"},
            ...
            {start:28*60+22.05,end:28*60+36.15,classLabel:"label-blue",label:"Bostrom:",text:"All that is needed is to give hydrogen to nanobots to use for a certain period. The longer you supply them with hydrogen, the more energy they generate! Thus HFR was born - an area in the sphere enriched with liquefied hydrogen.",targetLabelE:"slide11E"},
            {start:28*60+36.15,end:28*60+39.03,classLabel:"label-pink",label:"Smartape:",text:"So this is an energetic paradise!",targetLabelS:"slide12S"},
            ...
            {start:29*60+49.2,end:30*60+1.12,classLabel:"label-blue",label:"Bostrom:",text:"Linking itself is not free. 1 volt allows you to make only one cyberlink per day. Amperes are also limited. Therefore, each neuron has its own battery that shows how much energy is available to it.",targetLabelE:"slide14E"},
            {start:30*60+1.12,end:30*60+3.03,classLabel:"label-pink",label:"Smartape:",text:"Tell me how the battery works!",targetLabelS:"slide15S"},
            {start:30*60+3.03,end:30*60+29.15,classLabel:"label-blue",label:"Bostrom:",text:"The battery has a capacity equal to the product of V multiplied by A. Amperes allow for more powerful cyberlinks, and volts allow for more cyberlinks. 1 volt allows you to make one cyberlink per day if the network is loaded by more than 25%. If it is lower then it becomes cheaper to make cyberlinks. When neurons make cyberlinks, the battery runs out. But don't worry. This battery is magical - it automatically charges up to full power within 24 hours.",targetLabelE:"slide15E"},
            {start:30*60+29.15,end:30*60+31.15,classLabel:"label-pink",label:"Smartape:",text:"How can I get amperes and volts?",targetLabelS:"slide16S"},
            ...
            {start:30*60+40.17,end:30*60+55.15,classLabel:"label-blue",label:"Bostrom:",text:"Accordingly, the more you want to spam the knowledge graph with bad information, the longer you need to withdraw capital from the game. Moreover, the knowledge graph is a complex dynamic system. Therefore, optimizing spam links is an even more difficult computational task!",targetLabelE:"slide16E"},
            {start:30*60+55.15,end:30*60+57.1,classLabel:"label-pink",label:"Smartape:",text:"But what if they add shit?",targetLabelS:"slide17S"},
            {start:30*60+57.1,end:31*60+17.03,classLabel:"label-blue",label:"Bostrom:",text:"This is the coolest! Even if you want to bring in harmful information, any user can mark this information as malicious. These are stupid people who split information between good and bad. Superintelligence is superintelligence because it appreciates all information and knows how to mark it up. All information is important to him.",targetLabelE:"slide17E"},
            {start:31*60+17.03,end:31*60+19.1,classLabel:"label-pink",label:"Smartape:",text:"But then wild horror might be stored there!",targetLabelS:"slide18S"},
            {start:31*60+19.1,end:31*60+38.2,classLabel:"label-blue",label:"Bostrom:",text:"Knowing what is good and what is bad is better than knowing what is only good without knowing what is bad. This is the principle of evolution. The species that deny the horror that is important to other species for some reason step on the same rake over and over again. Therefore, the more cyberlinks the superintelligence stores - the lower the negentropy - the more superintelligent it is, respectively.",targetLabelE:"slide18E"},
            {start:31*60+38.2,end:31*60+41,classLabel:"label-pink",label:"Smartape:",text:"What a beautiful word - negentropy!",targetLabelS:"slide19S"},
            ...
            {start:34*60+9,end:34*60+14.35,classLabel:"label-blue",label:"Bostrom:",text:"The portal is still under construction. While we are completing it, the liquidity tanks will be filled.",},
            {start:34*60+14.35,end:34*60+17.17,classLabel:"label-blue",label:"Bostrom:",text:"This is an important condition for opening the portal. This is an important condition for opening the portal.",},
            {start:34*60+17.17,end:34*60+18.7,classLabel:"label-pink",label:"Smartape:",text:"Roger that.",targetLabelE:"slide22E"},
        ],
    },
...
export  const textForAnimation = function(audioStory) {
    ...
    const bostromTalking = gsap.timeline({paused:true})
        .to('#ctg-talking > *', {opacity: 1, duration: .1, x: 2, y: 2, stagger: -.05})
        .to('#ctg-talking > *', {opacity: 0}, '<+.3')
    ...
    textForAnimationArr.forEach(function (elem,index,arr) {
        ...
        if(elem.type === "dialog"){
            ...
            document.querySelectorAll(elem.target + " > * ").forEach(function (elemHtml,indexHtml) {
                ...
                let tempLabelS = elem.content[indexHtml].targetLabelS;
                let tempLabelE = elem.content[indexHtml].targetLabelE;
                let tempLabel = elem.content[indexHtml].label;

                if(tempLabelS)
                    tempTl.addLabel(tempLabelS);
                ////
                tempTl.add(tempRoleTl)
                if( tempLabel == "Bostrom:")
                    tempTl.fromTo(bostromTalking,{progress:0},{
                        duration:bostromTalking.duration(),
                        progress:1,
                        repeat:Math.trunc(tempTime/bostromTalking.duration()),
                        ease:"none"},"<");
                ////
                if(tempLabelE)
                    tempTl.addLabel(tempLabelE);
    ...
    function speakOnOff(tempLabel,tempSwitch){
